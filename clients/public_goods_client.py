...
class PublicGoodsClient(DefaultClient):
    ...
    def night_msg_page(self):
        st.write("Waiting server start night...")
    ...
    def day_msg_page(self):
        st.write("Waiting server start day...")
        ...
        st.button('Send', key='daysend', on_click=sending_mail, kwargs={'time': 'day', 'player_msgs': player_msgs})
